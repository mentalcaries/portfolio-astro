...
FairGrade features a mobile-first grading interface for consultant physicians in the field and a comprehensive desktop dashboard for the lead consultant to manage students, consolidate assessments, calculate grades, and export final scores. The platform handles complex hierarchical data including multiple classes, groups, hospital units, and location-based assignments, with role-based permissions ensuring consultants only access their assigned students. 
